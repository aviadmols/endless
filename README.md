...
| חלק | כתובת | תיאור |
|---|---|---|
| עמוד הבית | `/` | עמוד נחיתה בסגנון "יד לשריון": כרטיס לבן, ארבע תכונות, "איך זה עובד", טופס לידים |
...
| אזור אישי | `/dashboard` | סקירה, עריכת העמוד, ניהול זיכרונות, שיתוף, חשבון |
| ניהול | `/admin` | הגדרות SMTP / 019SMS, עמודי הנצחה, משתמשים, פניות, תוכן עמוד הבית |
