...
| ספר הזיכרונות | `/dashboard/book` | בחירת תוכן, גודל וצבע כריכה, תצוגה מלאה של ספר פתוח עם הפיכת דפים, עריכת טקסט ותמונות בכל עמוד, ומספר עותקים (ההזמנה עדיין סגורה) |
